...
- Treat `core/RISKS.md` as the active risk register. Use the `review-risks` skill when walking risks one by one to keep, update, close, punt, or mark evidence needed.
