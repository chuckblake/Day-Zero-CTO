...
- `OPERATING_CADENCE.md`: weekly review rhythm, CEO update rhythm, planning cycle, incident or reliability review rhythm, expected artifacts, and `## Index Cadence Rules` rows for dashboard due alerts, including weekday intent where a ritual has a normal day.
